...
import { adminApi, getAuthToken, type AdminMeNotificationRow } from '@/lib/api';
import { mapPortalNotificationUiType } from '@/lib/portalNotifications';

type AdminNotificationsModalProps = {
  open: boolean;
...
export default function AdminNotificationsModal({ open, onOpenChange }: AdminNotificationsModalProps) {
  ...
  const markReadMutation = useMutation({
    mutationFn: (body: { all?: boolean; ids?: string[] }) => adminApi.meNotificationsMarkRead(body),
    onSuccess: () => {
  ...
  const handleRowActivate = (n: AdminMeNotificationRow) => {
    if (!n.is_read) {
