    ...
    extend: {
      ...
      colors: {
        ...
        category: {
          ...
          fresh: "hsl(var(--category-fresh))",
          electronics: "hsl(var(--category-electronics))",
          mobiles: "hsl(var(--category-mobiles))",
        ...
        storefront: {
          pink: "hsl(var(--storefront-pink))",
          green: "hsl(var(--storefront-green))",
          orange: "hsl(var(--storefront-orange))",
          "orange-deep": "hsl(var(--storefront-orange-deep))",
        },
      },
      borderRadius: {
        lg: "var(--radius)",
